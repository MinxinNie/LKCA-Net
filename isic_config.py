...
from isic_utils import BceDiceLoss, myNormalize_multi, myToTensor_multi, myRandomHorizontalFlip_multi, \
    myRandomVerticalFlip_multi, myRandomRotation_multi, myResize_multi
from utils import *
...
class setting_config:
    ...
    cfg=r'C:\Users\puff\Desktop\LALK-NET\configs\agileFormer_base_isic.yaml'
    test_weights = ''

    datasets = 'isic18'
    # datasets = 'isic17'
    # datasets = "PH2"
    print("single-task dataset ->", datasets)
    if datasets == 'isic18':
        data_path = r'C:\\Users\\puff\\Desktop\\data_isic1718\\isic2018\\'
    ...
    rank = None
    amp = False
    batch_size = 16   # MALUnet 3ka-> 512   TransFuse 3ka -> 32  TransUNet -> 64  sigle-task max-swin -> 32
    epochs = 300
    ...
    test_transformer = transforms.Compose([
        myNormalize("ISIC2018", train=False),
        myToTensor(),
        myResize(input_size_h, input_size_w)
    ])
